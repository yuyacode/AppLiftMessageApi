...
//go:generate go run github.com/matryer/moq -out moq_test.go . CredentialGetter CredentialSetter MessageOwnerGetter MessageGetter MessageAdder MessageEditor MessageDeleter
