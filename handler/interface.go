...
//go:generate go run github.com/matryer/moq -out moq_test.go . RegisterOAuthService RefreshAccessTokenService GetMessageService AddMessageService EditMessageService DeleteMessageService
